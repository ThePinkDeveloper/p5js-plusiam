...
export class Game {
    ...
    dragged() {
        ...
        if (!!blockClicked && this.selected.length === 0) {
            blockClicked.selected = true;
            this.selected.push(blockClicked);
        } else if (!!blockClicked && this.selected.length !== 0 && !this.selected.includes(blockClicked) 
            && (this.selected[this.selected.length - 1].row === blockClicked.row ||
                this.selected[this.selected.length - 1].column === blockClicked.column)) {
            blockClicked.selected = true;
            this.selected.push(blockClicked);
